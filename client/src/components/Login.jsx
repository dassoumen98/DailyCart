...
const Login = () => {
    ...
    const {setShowUserLogin, setUser , axios,navigate , fetchAuthUser} = useAppContext();
    ...
    return (
        <div onClick={()=>setShowUserLogin(false)} className="fixed top-0 left-0 bottom-0 right-0 z-30 bg-black/30 backdrop-blur-sm flex items-center justify-center">
